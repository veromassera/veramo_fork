...
import bbsEcdsa from '@veramo-community/lds-ecdsa-secp256k1-recovery2020'
import { asArray, bytesToBase64, concat, encodeJoseBlob, intersect, stringToUtf8Bytes } from '@veramo/utils'

const { EcdsaSecp256k1RecoveryMethod2020, EcdsaSecp256k1RecoverySignature2020 } = bbsEcdsa
 ...
 */
export class VeramoEcdsaSecp256k1RecoverySignature2020 extends VeramoBbsSignature {
